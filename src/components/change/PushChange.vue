<template>
    <div class="add-product">
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>发布以物换物</el-breadcrumb-item>
        </el-breadcrumb>
        <h2>添加商品</h2>
        <el-form :model="form" ref='goodsForm' label-width="120px" class="form-container" :rules="rules">
            ...
            <el-form-item label="期望交换物" prop="hope">
                <el-input v-model="form.hope"></el-input>
            </el-form-item>
    ...
    data() {
        ...
        return {
            ...
            rules: {
                ...
                hope:[
                    {required: true, message: "请输入期望交换的物品", trigger: "blur" },
                    { max: 50, min: 1, message: "描述长度在50个字符以内", trigger: "blur" },
                ],
        ...
        handleSubmit() {
            ...
            this.$refs.goodsForm.validate(valid => {
                ...
                if (valid) {
                    ...
                    // 将表单数据提交到后端
                    this.$http.post('changegoods/add', this.form).then((res) => {
                        if (res.data.code == 1) {
